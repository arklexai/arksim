...
>   XYZ Insurance offers three tiers of home insurance: Basic Form, Broad Form, and Comprehensive Form…
> - `claims_process.pdf` \
>   To file a claim, log into your account or call the claims line at 1-800-555-0199…
...
<ResponseField name="scenarios" type="list[dict]" required>
  ...
  <Expandable title="scenario fields">
    ...
    <ResponseField name="origin" type="dict[string, Any]">
      Freeform metadata used to record how a scenario was generated. It is not used by the simulator or evaluator and exists purely for provenance tracking.
