...
<ResponseField name="scenarios" type="list[dict]" required>
  ...
  <Expandable title="scenario fields">
    ...
    <ResponseField name="origin" type="dict[string, Any]">
      ...
      - `user_attributes`: Structured key-value map of the user's traits (demographic, personality, behavioral).
    </ResponseField>
  </Expandable>
</ResponseField>
...
You can write scenario files manually. The minimum required fields are `scenario_id`, `goal`, and `user_profile`:
