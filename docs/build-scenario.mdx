...
| ---------------------- | ---------------------- | -------------------------------------------------------------------- |
| `goal`                 | Simulator & Evaluator  | User's objective; used in the simulator prompt and in goal-completion evaluation. |
| `knowledge[].content`  | Simulator & Evaluator  | Simulated user's background knowledge; used in simulator prompt and in evaluation (e.g. faithfulness).          |
| `user_attributes`      | Simulator & Report     | Simulated user's persona; used in simulator for profile generation; displayed in HTML evaluation report. |
