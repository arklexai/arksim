...
<Steps>
  ...
  <Step title="Run Simulation & Evaluation">
    ...
    **Download examples:** From your project directory, run:
    ...
    <Note>
      You can run **e-commerce**, **customer-service**, and **openclaw** the same way from `examples/e-commerce`, `examples/customer-service`, and `examples/openclaw`. See the example guides in Next Steps below.
    </Note>
  </Step>
