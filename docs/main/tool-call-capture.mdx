...
| Chat Completions | Planned | Planned (W3C Trace Context infrastructure ready) |
| A2A | Planned | Planned (W3C Trace Context infrastructure ready) |

<Info>
Tool call capture currently works with the Python connector only. W3C Trace Context infrastructure is in place for Chat Completions and A2A but requires end-to-end validation with OTel-instrumented wrapper servers (follow-up PR).
</Info>
