...
For the full structure and field order, see [Simulation output (`simulation.json`)](/schema-reference#simulation-output-simulationjson) in the Schema Reference.
