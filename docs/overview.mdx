...
Evaluation scores your agent on those conversations. You get metrics (e.g. helpfulness, faithfulness), behavior failure labels, and a deduplicated list of unique errors to fix.
...
<CardGroup cols={2}>
  ...
  <Card icon="briefcase" href="/examples/insurance-customer-service-agent-evaluation" title="Insurance Agent Example">
